...
export const projects = [
    ...
    },
    {
        ...
        description: "This portfolio app, built using Next.js, showcases a comprehensive overview of your professional journey. It provides a user-friendly interface that highlights your skills, education, experience, and projects. The app leverages MongoDB for efficient data storage and management, ensuring a seamless user experience.",
        stack: ["Next JS", "Mongo DB", "Framer Motion", "Shadcn UI", "Tailwind CSS"],
    ...
    },
    {
        ...
        description: "Built a scalable web application using Next.js, MySQL, and AWS. Implemented secure image uploads with AWS S3 storage, optimizing website performance through Tailwind CSS and Ant Design integration. AWS EC2 and Nginx were used for hosting",
    ...
    },
    {
        ...
        description: "Developed a comprehensive video browsing platform using the MERN stack along with a friend. The platform offers a responsive user interface across various devices and incorporates robust user authentication and authorization with Firebase. Users can actively engage with the platform by adding and removing bookmarks. A scalable backend infrastructure was established using Node.js, Express.js, Firebase, and other relevant technologies.",
        stack: ["MERN", "React JS", "Redux Toolkit", "Node JS", "Express JS", "Firebase", "Mongo DB"],
        image: "/img/entertainment_app.png",
        live: "https://entertainment--webapp.vercel.app/login/",
        github: "https://github.com/Magar0/entertainment-app-AlmaBetter-FinalProject",
    },
    {
        id: "05",
        category: "Frontend",
        title: "Simple Beauty Product Homepage",
        description: "Made a simple E-commerce product homepage using HTML , Bootstrap,javaScript",
        stack: ["Bootstrap", "Javascript"],
        image: "/img/beauty_product.png",
        live: "https://magar0.github.io/Simple-Product-Homepage-HTML-CSS-JS/",
        github: "https://github.com/Magar0/Simple-Product-Homepage-HTML-CSS-JS?tab=readme-ov-file",
    },
    {
        id: "06",
        category: "Frontend",
        title: "Car Website",
        description: "Developed a fully responsive car website using Bootstrap and Redux. The website features two pages: a main page for browsing cars and a detailed page for each individual car. Redux is used to manage global state.",
    ...
    },
    {
        ...
        description: "A RESTful API with user authentication, role-based access control, and secure API endpoints. Implemented user authentication (JWTs) and role-based access control for authorization. Comprehensive User Management: Users can view & update profiles, while Admins have full CRUD access. Robust Security: Middleware and input validation techniques ensure data integrity.",
